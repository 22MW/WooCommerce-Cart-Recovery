...
require_once WCCR_PLUGIN_DIR . 'includes/locale/class-plugin-locale-switcher.php';
...
require_once WCCR_PLUGIN_DIR . 'includes/repositories/class-stats-repository.php';
...
require_once WCCR_PLUGIN_DIR . 'includes/domain/class-exclusion-service.php';
require_once WCCR_PLUGIN_DIR . 'includes/domain/class-exclusion-translation-service.php';
...
require_once WCCR_PLUGIN_DIR . 'includes/domain/class-audit-logger.php';
